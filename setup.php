...
"access" => "CREATE TABLE access (
    ...
    is_active INTEGER DEFAULT 1, granted_at TEXT DEFAULT (datetime('now','localtime')),
...
"events" => "CREATE TABLE events (
    ...
    created_at TEXT DEFAULT (datetime('now','localtime')), resolved_by TEXT
)",
"comments" => "CREATE TABLE comments (
    ...
    content TEXT NOT NULL, created_at TEXT DEFAULT (datetime('now','localtime'))
)",
